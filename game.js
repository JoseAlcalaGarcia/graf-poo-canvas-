...
function draw7() {
    ...
    if (canvas1.getContext) {
      ...
      canvas1.width = 400;
    canvas1.height = 400;// Canvas setup
    const canvas = document.getElementById('gameCanvas');
    const ctx = canvas.getContext('2d');
    ...
    // Mover el origen de coordenadas para que la figura no se salga
    
      // Ejemplo de curvas cúbicas
      ctx1.beginPath();
      ctx1.moveTo(75 * 3, 40 * 3);
      ctx1.bezierCurveTo(75 * 3, 37 * 3, 70 * 3, 25 * 3, 50 * 3, 25 * 3);
      ctx1.bezierCurveTo(20 * 3, 25 * 3, 20 * 3, 62.5 * 3, 20 * 3, 62.5 * 3);
      ctx1.bezierCurveTo(20 * 3, 80 * 3, 40 * 3, 102 * 3, 75 * 3, 120 * 3);
      ctx1.bezierCurveTo(110 * 3, 102 * 3, 130 * 3, 80 * 3, 130 * 3, 62.5 * 3);
      ctx1.bezierCurveTo(130 * 3, 62.5 * 3, 130 * 3, 25 * 3, 100 * 3, 25 * 3);
      ctx1.bezierCurveTo(85 * 3, 25 * 3, 75 * 3, 37 * 3, 75 * 3, 40 * 3);
      ctx1.fillStyle = "red"; 
      ctx1.fill();
